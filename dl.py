...
model=tensorflow.keras.models.load_model("C:\\Users\\ABI\\Downloads\\abi_model.h5")
...
while run:
    ...
    image_resize = cv2.resize(frame1,(224,224))
    frame1 = cv2.cvtColor(image_resize, cv2.COLOR_BGR2RGB)
    time.sleep(0.075)
    _, frame2 = camera.read()
    image_resize = cv2.resize(frame2,(224,224))
